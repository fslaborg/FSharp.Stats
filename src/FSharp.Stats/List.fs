...
module List =
    ...
    /// <summary>
    ///   Computes the population covariance of two random variables generated by applying the function to each input list.
    /// </summary>
    ///    
    ...
    /// <remarks>Returns NaN if data is empty or if any entry is NaN.</remarks>
    /// <returns>population covariance estimator (denominator N)</returns> 
    let inline covPopulationBy f (list1:list<'T>) (list2:list<'T>) : 'U =
        Seq.covPopulationBy f list1 list2
    ...
    /// <remarks>Returns NaN if data is empty or if any entry is NaN.</remarks>
    /// <returns>sample covariance estimator (Bessel's correction by N-1)</returns>
    let inline covBy f (list1:list<'T>) (list2:list<'T>) : 'U =
        Seq.covBy f list1 list2