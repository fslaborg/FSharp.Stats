...
module Array =
    ...
    /// <summary>
    ///   Computes the population covariance of two random variables generated by applying the function to each input array.
    /// </summary>
    ///    
    /// <param name="f">A function applied to transform each element of each input list.</param>
    /// <param name="array1">The first input array.</param>
    /// <param name="array2">The second input array.</param>
    /// <remarks>Returns NaN if data is empty or if any entry is NaN.</remarks>
    /// <returns>population covariance estimator (denominator N)</returns> 
    let inline covPopulationBy f (array1:array<'T>) (array2:array<'T>) : 'U =
        Seq.covPopulationBy f array1 array2
    ...
    /// <summary>
    ///   Computes the sample covariance of two random variables generated by applying the function to each input list.
    /// </summary>
    ///    
    /// <param name="array1">The first input array.</param>
    /// <param name="array2">The second input array.</param>
    /// <remarks>Returns NaN if data is empty or if any entry is NaN.</remarks>
    /// <returns>sample covariance estimator (Bessel's correction by N-1)</returns>
    let inline covBy f (array1:array<'T>) (array2:array<'T>) : 'U =
        Seq.covBy f array1 array2