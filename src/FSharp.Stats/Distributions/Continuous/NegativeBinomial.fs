...
type NegativeBinomial =
    ...
    //    NegativeBinomial.CheckParam alpha beta
    ...
    //    sqrt (NegativeBinomial.Variance alpha beta)
    ...
    //    sprintf "NegativeBinomial(α = %f, β = %f)" alpha beta
    ...
    //        member d.Mean              = NegativeBinomial.Mean alpha beta
    //        member d.StandardDeviation = NegativeBinomial.StandardDeviation alpha beta   
    //        member d.Variance          = NegativeBinomial.Variance alpha beta
    //        member d.CDF x             = NegativeBinomial.CDF alpha beta x

    //        member d.Mode              = NegativeBinomial.Mode alpha beta
    //        member d.Sample ()         = NegativeBinomial.Sample alpha beta
    //        member d.PDF x             = NegativeBinomial.PDF alpha beta x           
            
    //        override d.ToString()  = NegativeBinomial.ToString alpha beta
    //    }
