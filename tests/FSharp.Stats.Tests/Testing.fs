...
let wilcoxonTestTests = 
    ...
    let wilcoxon3 = WilcoxonTest.createWilcoxonTestWithDifferences differences true 
    let wilcoxon4 = WilcoxonTest.createWilcoxonTestWithDifferences differences false
